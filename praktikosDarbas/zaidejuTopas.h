...
void generuotiHtml(int kiekis) {
    ...
    if (zaidejuTop.is_open()) {
        ...
        zaidejuTop << "<style>" << "\n";
        zaidejuTop << "html{" << "\n";
        zaidejuTop << "    background: url('https://wallpapercave.com/wp/wp2646214.jpg') no-repeat center center fixed; " << "\n";
        ...
        zaidejuTop << "}" << "\n";
        zaidejuTop << "td, th {" << "\n";
        zaidejuTop << "    border: 1px solid black;" << "\n";
        ...
        zaidejuTop << "    background-color: lightgray;" << "\n";
        zaidejuTop << "    opacity: 1;" << "\n";
        zaidejuTop << "}" << "\n";
        zaidejuTop << "tr:nth-child(odd) {" << "\n";
        zaidejuTop << "    background-color: lightblue;" << "\n";
        zaidejuTop << "    opacity: 1;" << "\n";
        zaidejuTop << "}" << "\n";
        zaidejuTop << "</style>" << "\n";
        zaidejuTop << "</head>" << "\n";
        zaidejuTop << "<body>" << "\n";
        zaidejuTop << "<h1 align=\"center\" style=\"color:black\">ŽAIDIMO KOMPANIJA LYDERIAI</h2>" << "\n";
