...
void saugojimas(int nr, char zemelapis[30][120], int zemPlotis, int zemAukstis, int xZaid, int yZaid, int xMiest, int yMiest, int xKaim, int yKaim, int dungKord[30], int kuriMisija, char temp, char temp1, int zaidejoPasiekimai[15]) {
    if (nr == 1) {
        ofstream saugoti("saugojimoVieta_1.txt");
        if (saugoti.is_open()) {
            for (int i = 0; i < 30; i++) {
                for (int j = 0; j < 120; j++) {
        ...
        ofstream saugoti("saugojimoVieta_2.txt");
        if (saugoti.is_open()) {
            for (int i = 0; i < 30; i++) {
                for (int j = 0; j < 120; j++) {
                    saugoti << zemelapis[i][j];
        ...
        ofstream saugoti("saugojimoVieta_3.txt");
        if (saugoti.is_open()) {
            for (int i = 0; i < 30; i++) {
                for (int j = 0; j < 120; j++) {
                    saugoti << zemelapis[i][j];
        ...
        ofstream saugoti("saugojimoVieta_4.txt");
        if (saugoti.is_open()) {
            for (int i = 0; i < 30; i++) {
                for (int j = 0; j < 120; j++) {
                    saugoti << zemelapis[i][j];
        ...
        ofstream saugoti("saugojimoVieta_5.txt");
        if (saugoti.is_open()) {
            for (int i = 0; i < 30; i++) {
                for (int j = 0; j < 120; j++) {
                    saugoti << zemelapis[i][j];
